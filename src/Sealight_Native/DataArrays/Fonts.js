const Fonts = [
    'Arial, sans-serif', 'Helvetica, sans-serif', 'Verdana, sans-serif', 'Trebuchet MS, sans-serif', 'Gill Sans, sans-serif', 'Noto Sans, sans-serif',
    ...
    'Stencil Std, fantasy', 'Marker Felt, fantasy', 'Trattatello, fantasy', 'fantasy', 'inherit',
];
